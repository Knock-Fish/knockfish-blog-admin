    ...
    <div ref="divRef" class="page">
        ...
        <PageTable class="table" :columns="columns" :table-data="tableData"
            ...
            <template #permission="{ row }">
                <DialogButton :permission="RolePerm.EDIT" :button-props="permissionButtonProps"
            ...
            <!-- 自定义操作列 -->
            <template #option="{ row }">
                <DialogButton :permission="RolePerm.EDIT" :button-props="editButtonProps" @click="getData(row)"
                ...
                <DialogButton type="button" :permission="RolePerm.DELETE" :button-props="delButtonProps"
                @click="handleDel(row)">
                    删除
                </DialogButton>
            </template>
